...
class ThemeValidator:
    ...
    def validate_wordpress_functions(self, code: str, filename: str) -> Tuple[List[str], List[str]]:
    ...
    def validate_file_complete(
        self, content: str, filename: str, fallback_content: str
    ) -> ValidationResult:
    ...
    def validate_theme_complete(
        self, theme_files: Dict[str, str], fallback_templates: Dict[str, str]
...
def validate_and_get_safe_content(
    content: str, filename: str, fallback_content: str, enable_fallback: bool = True
