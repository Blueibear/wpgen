...
class ThemePackager:
    ...
    def create_theme_directory(self, theme_name: str, clean_existing: bool = False) -> Path:
    ...
    def write_file(
        self, theme_path: Path, filename: str, content: str, create_dirs: bool = True
    ) -> Path:
    ...
    def write_files_batch(self, theme_path: Path, files: Dict[str, str]) -> List[Path]:
...
"""
    ...
    def generate_readme_txt(
        self, theme_name: str, description: str, changelog: Optional[List[str]] = None
    ) -> str:
...
"""
    ...
    def create_zip_archive(self, theme_path: Path, output_name: Optional[str] = None) -> Path:
    ...
    def finalize_theme(
        self, theme_path: Path, create_zip: bool = True, validate: bool = True
    ) -> Dict[str, any]:
