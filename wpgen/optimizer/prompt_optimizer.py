...
class PromptOptimizer:
    ...
    def _rewrite_prompt(
        ...
        sections.append("• All PHP files must be syntactically valid (no unmatched braces)")
        sections.append("• header.php must open <main id=\"content\"> but NOT close it")
        sections.append("• footer.php must close </main> and include wp_footer()")
        sections.append("• All templates must call get_header() and get_footer()")
        sections.append("• Use proper WordPress functions (wp_nav_menu, get_template_part, etc)")
        sections.append("• Escape all output (esc_html, esc_url, esc_attr)")
        sections.append("• Use proper WordPress loop structure")
        sections.append("• Include proper WordPress theme headers in style.css")
        sections.append("• Enqueue scripts/styles properly in functions.php")
        sections.append("• Use translation functions for all user-facing text")
        sections.append("• Follow WordPress coding standards")
